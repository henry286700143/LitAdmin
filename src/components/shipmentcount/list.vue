  ...
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-table :data="books" highlight-current-row @selection-change="selsChange"
        ...
        <el-table-column prop="name" label="书名1" sortable></el-table-column>
        <el-table-column prop="author" label="作者1" width="100" sortable></el-table-column>
        <el-table-column prop="publishAt" label="出版日期1" width="150" sortable></el-table-column>
      ...
      <el-dialog title="编辑" :visible.sync ="editFormVisible" :close-on-click-modal="false">
        <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
          <el-form-item label="书名1" prop="name">
  ...
  export default{
    data(){
      return {
        ...
        editFormRules: {
          name: [
            {required: true, message: '请输入书名1', trigger: 'blur'}
          ],
          author: [
            {required: true, message: '请输入作者1', trigger: 'blur'}
          ],
          description: [
            {required: true, message: '请输入简介1', trigger: 'blur'}
          ]
        },
        editForm: {
          id: 0,
